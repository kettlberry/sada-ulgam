...
!function (t) {
    ...
    var a = ':input:not([type="submit"], button):enabled:visible', r = function (e, a) {
        for (var i in this.$element = t(e), this.options = a, a.errors = t.extend({}, r.DEFAULTS.errors, a.errors), a.custom) if (!a.errors[i]) throw new Error("Missing default error message for custom validator: " + i);
    ...
    r.DEFAULTS = {
        ...
        if (a.is('[type="radio"]') && (a = this.$element.find('input[name="' + a.attr("name") + '"]')), this.$element.trigger(e = t.Event("validate.bs.validator", {relatedTarget: a[0]})), !e.isDefaultPrevented()) {
            var i = this;
            this.runValidators(a).done((function (o) {
                a.data("bs.validator.errors", o), o.length ? i.showErrors(a) : i.clearErrors(a), r && o.toString() === r.toString() || (e = o.length ? t.Event("invalid.bs.validator", {
                    ...
                    relatedTarget: a[0],
                    detail: r
                }), i.$element.trigger(e)), i.toggleSubmit(), i.$element.trigger(t.Event("validated.bs.validator", {relatedTarget: a[0]}))
            }))
        }
        ...
        this.defer(e, (function () {
            var r = e.closest(".form-group"), i = r.find(".help-block.with-errors"),
                o = r.find(".form-control-feedback"), n = e.data("bs.validator.errors");
